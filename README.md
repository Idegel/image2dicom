...
Step 2. Run the shell bash file "convert_dicom".
...
Step 3. Run the change_dicom_ptname.py to change the dicom header so that you can view all the dicom as different patients now.
